...
Gist
 ...
 Watch 1,618
  Star 26,881
  Fork 11,184 django/django
 Code  Pull requests 144 Insights 
Branch: master Find file Copy pathdjango/django/db/models/query.py
b9f7dce  18 days ago
@bluetech bluetech Fixed #28010 -- Added FOR UPDATE OF support to QuerySet.select_for_up…
94 contributors @malcolmt @adrianholovaty @freakboy3742 @akaariai @timgraham @spookylukey @aaugustin @alex @jacobian @charettes @loic @claudep @gdub @carljm @jezdez @ramiro @felixxm @adamchainz @Ian-Foote @mjtamlyn @jarshwah @shaib @manfre @atombrella @mboersma @jkocherhans and others
RawBlameHistory     
1720 lines (1504 sloc)  69.5 KB
"""
